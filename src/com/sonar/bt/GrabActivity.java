...
public class GrabActivity extends Activity implements Runnable{
			...
			//	is.read();
		     ...
		     //Code that i added
		       	...
		       	//Change the meow.mp3 file to any file of your choice in the raw folder in and res and also change the name in the following line
		       		Util.getInstance().startPlaying(GrabActivity.this, MediaPlayer.create(GrabActivity.this, R.raw.meow));
		       	}
		       	//is.flush();
